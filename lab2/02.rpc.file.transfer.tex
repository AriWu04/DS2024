...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{rpc_design_diagram.png} % Replace with your image path
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{system_organization_diagram.png} % Replace with your image path
